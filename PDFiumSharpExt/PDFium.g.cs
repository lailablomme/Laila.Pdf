...
namespace PDFiumSharp
{
	public static partial class PDFium
	{
		...
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FPDFDOC_InitFormFillEnvironment")]
			internal static extern FPDF_FORMHANDLE FPDFDOC_InitFormFillEnvironment_x86(FPDF_DOCUMENT document, nint formInfo, nint jsPlatform);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FPDFDOC_InitFormFillEnvironment")]
			internal static extern FPDF_FORMHANDLE FPDFDOC_InitFormFillEnvironment_x64(FPDF_DOCUMENT document, nint formInfo, nint jsPlatform);
		}

		/// <include file='PDFium.xml' path='Documentation/FPDFDOC_InitFormFillEnvironment/*'/>
		public static FPDF_FORMHANDLE FPDFDOC_InitFormFillEnvironment(FPDF_DOCUMENT document, nint formInfo, nint jsPlatform)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { return PlatformInvoke.FPDFDOC_InitFormFillEnvironment_x64(document, formInfo, jsPlatform); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { return PlatformInvoke.FPDFDOC_InitFormFillEnvironment_x86(document, formInfo, jsPlatform); }
			else
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FPDFDOC_ExitFormFillEnvironment")]
			internal static extern void FPDFDOC_ExitFormFillEnvironment_x86(FPDF_FORMHANDLE form_handle);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FPDFDOC_ExitFormFillEnvironment")]
			internal static extern void FPDFDOC_ExitFormFillEnvironment_x64(FPDF_FORMHANDLE form_handle);
		}

		/// <include file='PDFium.xml' path='Documentation/FPDFDOC_ExitFormFillEnvironment/*'/>
		public static void FPDFDOC_ExitFormFillEnvironment(FPDF_FORMHANDLE form_handle)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { PlatformInvoke.FPDFDOC_ExitFormFillEnvironment_x64(form_handle); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { PlatformInvoke.FPDFDOC_ExitFormFillEnvironment_x86(form_handle); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FPDFPage_HasFormFieldAtPoint")]
			internal static extern int FPDFPage_HasFormFieldAtPoint_x86(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, double page_x, double page_y);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FPDFPage_HasFormFieldAtPoint")]
			internal static extern int FPDFPage_HasFormFieldAtPoint_x64(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, double page_x, double page_y);
		}

		/// <include file='PDFium.xml' path='Documentation/FPDFPage_HasFormFieldAtPoint/*'/>
		public static int FPDFPage_HasFormFieldAtPoint(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, double page_x, double page_y)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { return PlatformInvoke.FPDFPage_HasFormFieldAtPoint_x64(form_handle, page, page_x, page_y); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { return PlatformInvoke.FPDFPage_HasFormFieldAtPoint_x86(form_handle, page, page_x, page_y); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FPDF_FFLDraw")]
			internal static extern void FPDF_FFLDraw_x86(FPDF_FORMHANDLE form_handle, FPDF_BITMAP bitmap, FPDF_PAGE page, int start_x, int start_y, int size_x, int size_y, int rotate, int flags);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FPDF_FFLDraw")]
			internal static extern void FPDF_FFLDraw_x64(FPDF_FORMHANDLE form_handle, FPDF_BITMAP bitmap, FPDF_PAGE page, int start_x, int start_y, int size_x, int size_y, int rotate, int flags);
		}

		/// <include file='PDFium.xml' path='Documentation/FPDF_FFLDraw/*'/>
		public static void FPDF_FFLDraw(FPDF_FORMHANDLE form_handle, FPDF_BITMAP bitmap, FPDF_PAGE page, int start_x, int start_y, int size_x, int size_y, int rotate, int flags)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { PlatformInvoke.FPDF_FFLDraw_x64(form_handle, bitmap, page, start_x, start_y, size_x, size_y, rotate, flags); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { PlatformInvoke.FPDF_FFLDraw_x86(form_handle, bitmap, page, start_x, start_y, size_x, size_y, rotate, flags); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnFocus")]
			internal static extern bool FORM_OnFocus_x86(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnFocus")]
			internal static extern bool FORM_OnFocus_x64(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y);
		}

		/// <include file='PDFium.xml' path='Documentation/FORM_OnFocus/*'/>
		public static bool FORM_OnFocus(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { return PlatformInvoke.FORM_OnFocus_x64(form_handle, page, modifier, page_x, page_y); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { return PlatformInvoke.FORM_OnFocus_x86(form_handle, page, modifier, page_x, page_y); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnLButtonDoubleClick")]
			internal static extern bool FORM_OnLButtonDoubleClick_x86(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnLButtonDoubleClick")]
			internal static extern bool FORM_OnLButtonDoubleClick_x64(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y);
		}

		/// <include file='PDFium.xml' path='Documentation/FORM_OnLButtonDoubleClick/*'/>
		public static bool FORM_OnLButtonDoubleClick(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { return PlatformInvoke.FORM_OnLButtonDoubleClick_x64(form_handle, page, modifier, page_x, page_y); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { return PlatformInvoke.FORM_OnLButtonDoubleClick_x86(form_handle, page, modifier, page_x, page_y); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnLButtonDown")]
			internal static extern bool FORM_OnLButtonDown_x86(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnLButtonDown")]
			internal static extern bool FORM_OnLButtonDown_x64(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y);
		}

		/// <include file='PDFium.xml' path='Documentation/FORM_OnLButtonDown/*'/>
		public static bool FORM_OnLButtonDown(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { return PlatformInvoke.FORM_OnLButtonDown_x64(form_handle, page, modifier, page_x, page_y); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { return PlatformInvoke.FORM_OnLButtonDown_x86(form_handle, page, modifier, page_x, page_y); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnLButtonUp")]
			internal static extern bool FORM_OnLButtonUp_x86(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnLButtonUp")]
			internal static extern bool FORM_OnLButtonUp_x64(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y);
		}

		/// <include file='PDFium.xml' path='Documentation/FORM_OnLButtonUp/*'/>
		public static bool FORM_OnLButtonUp(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { return PlatformInvoke.FORM_OnLButtonUp_x64(form_handle, page, modifier, page_x, page_y); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { return PlatformInvoke.FORM_OnLButtonUp_x86(form_handle, page, modifier, page_x, page_y); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnRButtonDown")]
			internal static extern bool FORM_OnRButtonDown_x86(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnRButtonDown")]
			internal static extern bool FORM_OnRButtonDown_x64(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y);
		}

		/// <include file='PDFium.xml' path='Documentation/FORM_OnRButtonDown/*'/>
		public static bool FORM_OnRButtonDown(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { return PlatformInvoke.FORM_OnRButtonDown_x64(form_handle, page, modifier, page_x, page_y); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { return PlatformInvoke.FORM_OnRButtonDown_x86(form_handle, page, modifier, page_x, page_y); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnRButtonUp")]
			internal static extern bool FORM_OnRButtonUp_x86(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnRButtonUp")]
			internal static extern bool FORM_OnRButtonUp_x64(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y);
		}

		/// <include file='PDFium.xml' path='Documentation/FORM_OnRButtonUp/*'/>
		public static bool FORM_OnRButtonUp(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { return PlatformInvoke.FORM_OnRButtonUp_x64(form_handle, page, modifier, page_x, page_y); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { return PlatformInvoke.FORM_OnRButtonUp_x86(form_handle, page, modifier, page_x, page_y); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnMouseMove")]
			internal static extern bool FORM_OnMouseMove_x86(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnMouseMove")]
			internal static extern bool FORM_OnMouseMove_x64(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y);
		}

		/// <include file='PDFium.xml' path='Documentation/FORM_OnMouseMove/*'/>
		public static bool FORM_OnMouseMove(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, int modifier, double page_x, double page_y)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { return PlatformInvoke.FORM_OnMouseMove_x64(form_handle, page, modifier, page_x, page_y); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { return PlatformInvoke.FORM_OnMouseMove_x86(form_handle, page, modifier, page_x, page_y); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_DoDocumentJSAction")]
			internal static extern void FORM_DoDocumentJSAction_x86(FPDF_FORMHANDLE form_handle);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_DoDocumentJSAction")]
			internal static extern void FORM_DoDocumentJSAction_x64(FPDF_FORMHANDLE form_handle);
		}

		/// <include file='PDFium.xml' path='Documentation/FORM_DoDocumentJSAction/*'/>
		public static void FORM_DoDocumentJSAction(FPDF_FORMHANDLE form_handle)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { PlatformInvoke.FORM_DoDocumentJSAction_x64(form_handle); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { PlatformInvoke.FORM_DoDocumentJSAction_x86(form_handle); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_DoDocumentOpenAction")]
			internal static extern void FORM_DoDocumentOpenAction_x86(FPDF_FORMHANDLE form_handle);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_DoDocumentOpenAction")]
			internal static extern void FORM_DoDocumentOpenAction_x64(FPDF_FORMHANDLE form_handle);
		}

		/// <include file='PDFium.xml' path='Documentation/FORM_DoDocumentOpenAction/*'/>
		public static void FORM_DoDocumentOpenAction(FPDF_FORMHANDLE form_handle)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { PlatformInvoke.FORM_DoDocumentOpenAction_x64(form_handle); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { PlatformInvoke.FORM_DoDocumentOpenAction_x86(form_handle); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_DoDocumentAAction")]
			internal static extern void FORM_DoDocumentAAction_x86(FPDF_FORMHANDLE form_handle, int aaType);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_DoDocumentAAction")]
			internal static extern void FORM_DoDocumentAAction_x64(FPDF_FORMHANDLE form_handle, int aaType);
		}

		/// <include file='PDFium.xml' path='Documentation/FORM_DoDocumentAAction/*'/>
		public static void FORM_DoDocumentAAction(FPDF_FORMHANDLE form_handle, int aaType)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { PlatformInvoke.FORM_DoDocumentAAction_x64(form_handle, aaType); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { PlatformInvoke.FORM_DoDocumentAAction_x86(form_handle, aaType); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnAfterLoadPage")]
			internal static extern void FORM_OnAfterLoadPage_x86(FPDF_PAGE page, FPDF_FORMHANDLE form_handle);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnAfterLoadPage")]
			internal static extern void FORM_OnAfterLoadPage_x64(FPDF_PAGE page, FPDF_FORMHANDLE form_handle);
		}

		/// <include file='PDFium.xml' path='Documentation/FORM_OnAfterLoadPage/*'/>
		public static void FORM_OnAfterLoadPage(FPDF_PAGE page, FPDF_FORMHANDLE form_handle)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { PlatformInvoke.FORM_OnAfterLoadPage_x64(page, form_handle); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { PlatformInvoke.FORM_OnAfterLoadPage_x86(page, form_handle); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnBeforeClosePage")]
			internal static extern void FORM_OnBeforeClosePage_x86(FPDF_PAGE page, FPDF_FORMHANDLE form_handle);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnBeforeClosePage")]
			internal static extern void FORM_OnBeforeClosePage_x64(FPDF_PAGE page, FPDF_FORMHANDLE form_handle);
		}

		/// <include file='PDFium.xml' path='Documentation/FORM_OnBeforeClosePage/*'/>
		public static void FORM_OnBeforeClosePage(FPDF_PAGE page, FPDF_FORMHANDLE form_handle)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { PlatformInvoke.FORM_OnBeforeClosePage_x64(page, form_handle); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { PlatformInvoke.FORM_OnBeforeClosePage_x86(page, form_handle); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_DoPageAAction")]
			internal static extern void FORM_DoPageAAction_x86(FPDF_PAGE page, FPDF_FORMHANDLE form_handle, int aaType);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_DoPageAAction")]
			internal static extern void FORM_DoPageAAction_x64(FPDF_PAGE page, FPDF_FORMHANDLE form_handle, int aaType);
		}

		/// <include file='PDFium.xml' path='Documentation/FORM_DoPageAAction/*'/>
		public static void FORM_DoPageAAction(FPDF_PAGE page, FPDF_FORMHANDLE form_handle, int aaType)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { PlatformInvoke.FORM_DoPageAAction_x64(page, form_handle, aaType); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { PlatformInvoke.FORM_DoPageAAction_x86(page, form_handle, aaType); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_SelectAllText")]
			internal static extern bool FORM_SelectAllText_x86(FPDF_FORMHANDLE form_handle, FPDF_PAGE page);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_SelectAllText")]
			internal static extern bool FORM_SelectAllText_x64(FPDF_FORMHANDLE form_handle, FPDF_PAGE page);
		}

		/// <include file='PDFium.xml' path='Documentation/FORM_SelectAllText/*'/>
		public static bool FORM_SelectAllText(FPDF_FORMHANDLE form_handle, FPDF_PAGE page)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { return PlatformInvoke.FORM_SelectAllText_x64(form_handle, page); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { return PlatformInvoke.FORM_SelectAllText_x86(form_handle, page); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_GetSelectedText")]
			internal static extern ulong FORM_GetSelectedText_x86(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, byte[] buffer, ulong buflen);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_GetSelectedText")]
			internal static extern ulong FORM_GetSelectedText_x64(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, byte[] buffer, ulong buflen);
		}

		/// <include file='PDFium.xml' path='Documentation/FORM_GetSelectedText/*'/>
		public static ulong FORM_GetSelectedText(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, byte[] buffer, ulong buflen)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { return PlatformInvoke.FORM_GetSelectedText_x64(form_handle, page, buffer, buflen); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { return PlatformInvoke.FORM_GetSelectedText_x86(form_handle, page, buffer, buflen); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_ReplaceSelection")]
			internal static extern void FORM_ReplaceSelection_x86(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, byte[] wsText);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_ReplaceSelection")]
			internal static extern void FORM_ReplaceSelection_x64(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, byte[] wsText);
		}

		/// <include file='PDFium.xml' path='Documentation/FORM_ReplaceSelection/*'/>
		public static void FORM_ReplaceSelection(FPDF_FORMHANDLE form_handle, FPDF_PAGE page, byte[] wsText)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { PlatformInvoke.FORM_ReplaceSelection_x64(form_handle, page, wsText); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { PlatformInvoke.FORM_ReplaceSelection_x86(form_handle, page, wsText); }
			else
				throw new PlatformNotSupportedException();
		}
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnKeyDown")]
			internal static extern bool FORM_OnKeyDown_x86(FPDF_FORMHANDLE hHandle, FPDF_PAGE page, int nKeyCode, int modifier);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnKeyDown")]
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnKeyUp")]
			internal static extern bool FORM_OnKeyUp_x86(FPDF_FORMHANDLE hHandle, FPDF_PAGE page, int nKeyCode, int modifier);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnKeyUp")]
		...
		static partial class PlatformInvoke
		{
			[DllImport("pdfium_x86", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnChar")]
			internal static extern bool FORM_OnChar_x86(FPDF_FORMHANDLE hHandle, FPDF_PAGE page, int c, int modifier);

			[DllImport("pdfium_x64", CallingConvention = CallingConvention.StdCall, EntryPoint = "FORM_OnChar")]
			internal static extern bool FORM_OnChar_x64(FPDF_FORMHANDLE hHandle, FPDF_PAGE page, int c, int modifier);
		}

		/// <include file='PDFium.xml' path='Documentation/FORM_OnChar/*'/>
		public static bool FORM_OnChar(FPDF_FORMHANDLE hHandle, FPDF_PAGE page, int c, int modifier)
		{
			if (RuntimeInformation.ProcessArchitecture == Architecture.X64)
				lock(_lock) { return PlatformInvoke.FORM_OnChar_x64(hHandle, page, c, modifier); }
			else if (RuntimeInformation.ProcessArchitecture == Architecture.X86)
				lock(_lock) { return PlatformInvoke.FORM_OnChar_x86(hHandle, page, c, modifier); }
			else
				throw new PlatformNotSupportedException();
		}
